...
data_inicio = datetime(2024, 9, 1, tzinfo=timezone.utc)  # Define a data de início com fuso horário UTC
data_fim = datetime(2024, 10, 1, tzinfo=timezone.utc)     # Define a data de fim com fuso horário UTC
